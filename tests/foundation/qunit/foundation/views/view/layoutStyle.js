...
suite('BASIC LAYOUT VARIATIONS', commonSetup);
...
suite('BASIC LAYOUT VARIATIONS PERCENTAGE', commonSetup);
...
suite('ACCELERATED LAYOUT VARIATIONS', {
  setup: function(){
    commonSetup.setup();
...
suite('INVALID LAYOUT VARIATIONS', commonSetup);
...
suite('RESIZE FRAME', commonSetup);
