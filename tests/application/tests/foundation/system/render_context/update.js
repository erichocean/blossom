...
// Attribute Editing
// 
suite("SC.RenderContext#update - attrs", {
  setup: function() {
    elem = document.createElement('div');
...
// ID
// 
suite("SC.RenderContext#update - id", {
  setup: function() {
    elem = document.createElement('div');
    SC.$(elem).attr("id", "foo");
    context = SC.RenderContext(elem);
...
// Class Name Editing
// 
suite("SC.RenderContext#update - className", {
  setup: function() {
    elem = document.createElement('div');
...
// Style Editing
// 
suite("SC.RenderContext#update - style", {
  setup: function() {
    elem = document.createElement('div');
