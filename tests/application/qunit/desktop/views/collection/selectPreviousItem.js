...
suite("SC.CollectionView.selectPreviousItem", {
  setup: function() {
...
test("selectPreviousItem(extend=true, numberOfItems=undefined)", function() {
  var sel = selectionFromIndex(4),
...
test("selectPreviousItem(extend=true, numberOfItems=2)", function() {
  var sel = selectionFromIndex(4),
