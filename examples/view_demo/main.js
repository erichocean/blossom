...
function main() {
  ...
  //   }),
  // 
  //   button: ViewDemo.ButtonView.extend({
...
//     var button = ViewDemo.ButtonPane.create({
...
//     button.attach();
// 
//     var buttonD = ViewDemo.ButtonPane.create({
...
//     buttonD.attach();
// 
//     var buttonS = ViewDemo.ButtonPane.create({
...
//     buttonS.attach();
// 
//     var buttonDS = ViewDemo.ButtonPane.create({
...
//     buttonDS.attach();
// 
//     var button2 = ViewDemo.ButtonPane.create({
...
//     button2.attach();
// 
//     var button2D = ViewDemo.ButtonPane.create({
...
//     button2D.attach();
// 
//     var button2S = ViewDemo.ButtonPane.create({
...
//     button2S.attach();
// 
//     var button2DS = ViewDemo.ButtonPane.create({
...
//     button2DS.attach();
// 
//     var button3 = ViewDemo.ButtonPane.create({
...
//     button3.attach();
// 
//     var button3D = ViewDemo.ButtonPane.create({
...
//     button3D.attach();
// 
//     var button3S = ViewDemo.ButtonPane.create({
...
//     button3S.attach();
// 
//     var button3DS = ViewDemo.ButtonPane.create({
