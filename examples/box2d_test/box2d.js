...
Box2D.postDefs = [];
 (function() {
    ...
    W.b2Distance =
    function() {};
    W.Distance = function(b, e, f) {++W.b2_gjkCalls;
        var m = f.proxyA,
        r = f.proxyB,
        s = f.transformA,
        v = f.transformB,
        ...
        for (var P = 0, X, $ = 0; $ < 20;) {
            ...
            X.w = w.SubtractVV(X.wB, X.wA); ++$; ++W.b2_gjkIters;
            var ba = false;
            for (P = 0; P < T; P++) if (X.indexA == C[P] && X.indexB == J[P]) {
                ba = true;
                break
            }
            if (ba) break; ++t.m_count
        }
    ...
    u.prototype.InsertLeaf = function(b) {++this.m_insertionCount;
        if (this.m_root == null) {
            this.m_root = b;
    ...
    D.prototype.CreateProxy = function(b, e) {
        var f = this.m_tree.CreateProxy(b, e); ++this.m_proxyCount;
        this.BufferMove(f);
        return f
    };
    D.prototype.DestroyProxy = function(b) {
        this.UnBufferMove(b); --this.m_proxyCount;
    ...
    D.prototype.UpdatePairs = function(b) {
        ...
        for (f = 0; f < e.m_moveBuffer.length; ++f) {
            ...
            e.m_tree.Query(function(t) {
                ...
                x.proxyA = t < m ? t: m;
                x.proxyB = t >= m ? t: m; ++e.m_pairCount;
                return true
            },
            r)
        }
        for (f = e.m_moveBuffer.length = 0; f < e.m_pairCount;) {
            ...
            for (++f; f < e.m_pairCount;) {
                s = e.m_pairBuffer[f];
                if (s.proxyA != r.proxyA || s.proxyB != r.proxyB) break; ++f
            }
        }
    };
    ...
    o.TimeOfImpact = function(b) {++o.b2_toiCalls;
        var e = b.proxyA,
        f = b.proxyB,
        m = b.sweepA,
        r = b.sweepB;
 ...
 (function() {
    ...
    k.prototype.CreateFixture = function(a) {
        ...
        this.m_fixtureList = c; ++this.m_fixtureCount;
        c.m_body = this;
    ...
    k.prototype.DestroyFixture = function(a) {
        if (this.m_world.IsLocked() != true) {
            ...
            a.Destroy();
            a.m_body = null;
            a.m_next = null; --this.m_fixtureCount;
            this.ResetMassData()
        }
    };
    ...
    O.prototype.Destroy = function(a) {
        ...
        this.m_contactFactory.Destroy(a); --this.m_contactCount
    };
    ...
    h.prototype.DestroyController = function(a) {
        ...
        if (a.m_next) a.m_next.m_prev = a.m_prev;
        if (a.m_prev) a.m_prev.m_next = a.m_next;
        if (a == this.m_controllerList) this.m_controllerList = a.m_next; --this.m_controllerCount
    };
 ...
 (function() {
    ...
    A.prototype.Update = function(j) {
        ...
        o == true && q == false && j.EndContact(this); (this.m_flags & A.e_sensorFlag) == 0 && j.PreSolve(this, this.m_oldManifold)
    };
 ...
 (function() {
    ...
    F.b2DebugDraw = function() {
        ...
        this.m_sprite = {
            graphics: {
                clear: function() {
                    G.m_ctx.clearRect(0, 0, G.m_ctx.__sc_canvas__.width, G.m_ctx.__sc_canvas__.height)
                }
            }
        }
    };
